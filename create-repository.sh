...
REPO_NAME=""
REPO_USER="mcanouil"
REPO_TEMPLATE="mcanouil/repository"
OPEN=false

# bash ./create-repository.sh --repository {{name}} --path ~/Projects/perso
...
usage() {
  ...
  echo "  -t, --template    Repository template (default: mcanouil/repository)"
