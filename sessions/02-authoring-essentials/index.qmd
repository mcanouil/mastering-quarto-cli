...
| [env](https://quarto.org/docs/authoring/variables.qmd#env)                      | Print system environment variable.       |
...
: Shortcodes {#tbl-shortcodes tbl-colwidths="[25,75]" style="font-size: 75%;"}
...
::: {reuse="shortcodes-table"}
:::
::: {reuse="shortcode-definition"}
:::
:::
...
```{.yaml code-line-numbers="1-6|3|4|5" style="margin-bottom: 20px;"}
crossref:
  custom:
    - kind: float # <1>
      key: txt # <2>
