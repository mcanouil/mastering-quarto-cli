...
Recall the project types introduced in Session 1.
Here we examine their configuration and architecture in more detail.
...
::: {reuse="output-optimisation-text"}
:::
::: {reuse="output-optimisation-code"}
:::
:::
...
## Part 1: Create a Project Structure {.smaller}
