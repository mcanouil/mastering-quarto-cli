...
- *10 minutes*: Project setup and multi-format configuration.
- *5 minutes*: Share results and discussion.

## Part 1: Create a Project Structure (*4 minutes*)
...
## Part 2: Multi-Format Configuration (*3 minutes*)
...
## Part 3: Conditional Content (*3 minutes*)
...
## Part 4: Test Multiple Formats (**3 minutes**)
...
## Part 5: Add Project Features (*2 minutes*)
...
**Complete these to succeed**:

- Create a properly structured project with `_quarto.yml`.
- Configure at least 2 different output formats.
