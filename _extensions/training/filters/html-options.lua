...
---   - extensions.training.hide-navbar-title: hides navbar brand/title
...
<style>
/* extensions.training.hide-navbar-title: Hide navbar brand/title */
a.navbar-brand {
  display: none;
}
</style>
...
local function Meta(meta)
  ...
  -- Check extensions.training.hide-navbar-title option
  local training_config = meta_mod.get_extension_config(meta, 'training')
  if training_config and training_config['hide-navbar-title'] then
