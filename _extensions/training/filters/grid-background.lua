...
---   extensions.training.grid-background is true (default: false).
...
<style>
/* extensions.training.grid-background: true */
body {
  --grid-size: 50px;
...
local function Meta(meta)
  ...
  local config = training_config and training_config['grid-background']
