...
// Maps YAML frontmatter to training-document dispatcher function parameters.
// The dispatcher routes to the appropriate template based on document-type.
#show: training-document.with(
...
$else$
  ...
  training-colours(mode: effective-brand-mode)
$endif$
}
