...
---
--- @param function_name string The Typst function name (e.g., 'training-progress')
...
--- @return string Complete Typst function call (e.g., '#training-progress(value: 75)[]')
--- @usage local code = M.build_shortcode_function_call('training-progress', {value = 75})
--- @usage local code = M.build_shortcode_function_call('training-progress', {colour = 'blue'})
...
---
--- @param function_name string The Typst function name to call (e.g., 'training-divider')
...
--- @usage return { ['divider'] = M.create_shortcode_handler('training-divider') }
