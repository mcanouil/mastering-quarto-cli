...
-- training-code-window-annote-colour, training-code-window-circled-number,
-- training-code-window-annotation-item, training-code-window-annotated-content)
...
function Meta(meta)
  ...
  -- Read config from extensions.training.code-window namespace.
  ...
  -- Read hotfix sub-table from extensions.training.code-window.hotfix.
...
local function process_typst_block(block, next_block, wrap_expansions)
  ...
  -- the #training-code-window(...)[ opener and its closing ] in different
