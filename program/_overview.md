...
Through seven structured sessions, attendees will master the complete Quarto workflow from initial setup and Markdown fundamentals to advanced theming, multi-format publishing, and professional deployment strategies.
The workshop emphasises practical, hands-on learning with real-world applications, covering project architecture, computational integration across R/Python/Julia, advanced formatting techniques, and modern publishing workflows.
...
[![](https://github.com/codespaces/badge.svg){fig-align="center" fig-alt="Open in GitHub Codespaces"}](https://codespaces.new/mcanouil/quarto-physalia-course?quickstart=1&devcontainer_path=.devcontainer%2Fdevcontainer.json)
