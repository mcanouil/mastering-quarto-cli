...
- **Welcome & Overview**
  ...
  - Brief look at the [Quarto Guide](https://quarto.org/docs/guide/).
...
::: {layout-ncol="2" style="font-size: 60%;"}
::: {reuse="session1a" .fragment}
:::
::: {reuse="session1b" .fragment}
:::
::: {reuse="session1c" .fragment}
:::
:::
:::
